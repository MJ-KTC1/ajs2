...
#cl = LineClient()
cl = LineClient('ayubajh.16@gmail.com','nengaisahajh.1.1')
#cl = LineClient(authToken='ExJQJOLmQKDW921kcymd.uuHyLoFfRqxmGHas2emMdq.oj8UE6Yq4x33V/EVUWlFAs/Q2HeBoSxDg2iJB1lqeM0=')
cl.log("Auth Token : " + str(cl.authToken))
channel = LineChannel(cl)
cl.log("Channel Access Token : " + str(channel.channelAccessToken))

ki = LineClient('nengaisah779@gmail.com','nengaisahajh.1.1')
#ki = LineClient(authToken='Ex5Pi7oghuGLopgM2H19.a2AnRzo8nHQ/0lmSsz3dMq.ppEqEbTsuyYP+z3oS/Pys2SgQIO+3nXizF56dfov/N8=')
ki.log("Auth Token : " + str(ki.authToken))
channel1 = LineChannel(ki)
ki.log("Channel Access Token : " + str(channel1.channelAccessToken))

kk = LineClient('maniskalemajh@gmail.com','nengaisahajh.1.1')
#kk = LineClient(authToken='Ex7SJxSvb98xysGC1jvd.VRgJ4So9syy0OoZNtyudRq./t6el814Mqcjqoz8NCSph1b6vC28TwGp6/XZQ8smtCw=')
kk.log("Auth Token : " + str(kk.authToken))
channel2 = LineChannel(kk)
kk.log("Channel Access Token : " + str(channel2.channelAccessToken))

kc = LineClient('ayubzz1606@gmail.com','nengaisahajh.1.1')
#kc = LineClient(authToken='')
kc.log("Auth Token : " + str(kc.authToken))
channel3 = LineChannel(kc)
kc.log("Channel Access Token : " + str(channel3.channelAccessToken))

kg = LineClient(authToken='ExReXGddiSPjYievKuj2.zLLHa9dzbqx2R/s7nGTYCG.C0/moAjJMAqO0sUIIibwj5eN7J5KP/MZ/ZJVSLxnuFwEWSQYYcc55v6+D5i1t+M1.aaaaza',appName='BIZANDROID\t1.7.2\tAndroid OS\t6.0')
kg.log("Auth Token : " + str(kg.authToken))
channel4 = LineChannel(kg)
kg.log("Channel Access Token : " + str(channel4.channelAccessToken))

kj = LineClient(authToken='Exs9hTS6pBGg3oajZ7C0.GbE/caw4p5evwiGpapoHKa.HinBwXHZL1FsktwCWVPuLQ6sT0jRESdiq/G7LFWtNSLxRf/GzojPAnYF1KoZZcO9.aaaaza',appName='BIZANDROID\t1.7.2\tAndroid OS\t6.0')
kj.log("Auth Token : " + str(kj.authToken))
channel5 = LineChannel(kj)
kj.log("Channel Access Token : " + str(channel5.channelAccessToken))

sw = LineClient(authToken='ExPVGBO9ognUUoZuDml2.LfHYhtgyZK3qQxRgxFL0GG.n8o0iDLYPBSwA7Q9O7BJFq+b9A1ybUs1E0irgbnaFjVCiffJLLDPxXzqxxKo1ccn.aaaazq',appName='BIZANDROID\t1.7.2\tAndroid OS\t6.0') 
#sw = LineClient('ayubzz1606@gmail.com','nengaisahajh.1.1')
#sw = LineClient(authToken='Ex1lu8ZKmpkr4ONi4iw1.b9b4KE9tuDYCMk8g4aoFyq.LYR7aI4I7G95a7RUSAJ2tD1DmEsk')
...
Fmid = kj.getProfile().mid
Zmid = sw.getProfile().mid
KAC = [cl,ki,kk,kc]
ABC = [ki,kk,kc]
Bots = [mid,Amid,Bmid,Cmid,Dmid,Fmid,Zmid]
Dpk = admin + staff
...
def bot(op):
    ...
    try:
        ...
        if op.type == 19:
            ...
            exc = op.param2
            vic = op.param3
            if room in protectantijs:
                if vic not in Bots + admin:
                    pass
                if vic in Bots + admin:
                    if exc not in Bots + admin:
                        if exc in [mem.mid for mem in cl.getCompactGroup(room).members]:
                            if sw != None and room in sw.getGroupIdsInvited():
                                try:
                                    sw.acceptGroupInvitation(room)
                                    ...
                                    kk.acceptGroupInvitationByTicket(op.param1,Ticket)
                                    kc.acceptGroupInvitationByTicket(op.param1,Ticket)
                                    sw.kickoutFromGroup(room,[exc])
                                    G.preventedJoinByTicket = True
                                    sw.updateGroup(G)                                   
                                    cl.inviteIntoGroup(room, [admin] + admin)
                                    kt.leaveGroup(room)
                                    try:
                                        cl.inviteIntoGroup(room,[Zmid])
                                    except:
                                        random.choice(KAC).inviteIntoGroup(room,[Zmid])
                                        cl.inviteIntoGroup(room,[Zmid])
                                        pass
                                except Exception as error:
                                    logError(error)
            ...
            if op.param3 in Zmid:
                if op.param2 not in Bots:
                    try:
                        ...
                        random.choice(KAC).inviteIntoGroup(op.param1,[Zmid] + Zmid)
                    except:
                        pass
...
#===========BOT UPDATE============#
                        ...
                        if cmd == "cek1":
                            if msg._from in admin or msg._from in owner:
                               try:cl.inviteIntoGroup(to, ["u0120d12ccc0e2b89703a26684b190212"]);has = "OK"
                               except:has = "NOT"
                        ...
                        if cmd == "cek2":
                            if msg._from in admin or msg._from in owner:
                               try:ki.inviteIntoGroup(to, ["u0120d12ccc0e2b89703a26684b190212"]);has = "OK"
                               except:has = "NOT"
                               try:ki.kickoutFromGroup(to, ["u0120d12ccc0e2b89703a26684b190212"]);has1 = "OK"
                               except:has1 = "NOT"
                               if has == "OK":sil = "Normal"
                               else:sil = "Limit"
                               if has1 == "OK":sil1 = "Normal"
                        ...
                        if cmd == "cek1":   
                            if msg._from in admin or msg._from in owner:
                               try:kk.inviteIntoGroup(to, ["u0120d12ccc0e2b89703a26684b190212"]);has = "OK"
                               except:has = "NOT"
                               try:kk.kickoutFromGroup(to, ["u0120d12ccc0e2b89703a26684b190212"]);has1 = "OK"
                               except:has1 = "NOT"
                               if has == "OK":sil = "Normal"
                               else:sil = "Limit"
                               if has1 == "OK":sil1 = "Normal"
                        ...
                        if cmd == "cek4":
                            if msg._from in admin or msg._from in owner:
                               try:kc.inviteIntoGroup(to, ["u0120d12ccc0e2b89703a26684b190212"]);has = "OK"
                               except:has = "NOT"
                               try:kc.kickoutFromGroup(to, ["u0120d12ccc0e2b89703a26684b190212"]);has1 = "OK"
                               except:has1 = "NOT"
                               if has == "OK":sil = "Normal"
                               else:sil = "Limit"
                               if has1 == "OK":sil1 = "Normal"
